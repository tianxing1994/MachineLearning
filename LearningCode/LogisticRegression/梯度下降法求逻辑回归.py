...
# 使用实例:
# result_0 = descent(np_data, theta, batch_size=10, alpha=0.000001, stop_type=0, threshold=5000)
# result_1 = descent(np_data, theta, batch_size=1, alpha=0.000001, stop_type=1, threshold=0.000001)
# result_2 = descent(np_data, theta, batch_size=1, alpha=0.0001, stop_type=2, threshold=0.05)
result_0_scaled = descent(np_data_scaled, theta, batch_size=100, alpha=0.0001, stop_type=0, threshold=50000)

plotmat(*result_0_scaled)
print(*result_0_scaled)

most_likely_theta = np.array([1.68545478, 3.92239103, 3.65701923])
print(predict(X_scaled,most_likely_theta))
print(score(X_scaled,y,most_likely_theta))
